...
| CONSENT              | NOT_READY      | Domain suite + `GET /api/v0/consents`                                     | Consent grant/revoke commands over HTTP; trusted-circle JSON | Eng                     | Add grant/revoke/trusted-circle JSON                           | Pilot        |
...
| COORDINATION         | NOT_READY      | Cases list/claim (#58); veterans/me open_case                             | Service-request command JSON; durable async (D-022)          | Eng + owner             | D-022 + SR JSON                                                | Pilot        |
