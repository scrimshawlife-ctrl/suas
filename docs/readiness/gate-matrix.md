...
| CONSENT              | NOT_READY      | Domain + consents + trusted-circle invite/list/remove JSON                | Consent grant/revoke command JSON still thin       | Eng                     | Add grant/revoke HTTP commands                                 | Pilot        |
