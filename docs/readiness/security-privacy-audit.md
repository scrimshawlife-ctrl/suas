...
| S-06 | Info       | Dependency vulns             | Covered            | Vitest upgraded to 4.1.11 on 2026-08-29. `npm audit` reports 0 vulnerabilities and `npm run verify` passes. This dev-tooling remediation does not change pilot or production readiness gates.                                                      |
